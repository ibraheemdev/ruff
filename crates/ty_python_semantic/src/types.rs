...
#[salsa::tracked(returns(ref), heap_size)]
...
impl<'db> Type<'db> {
    ...
    #[salsa::tracked(cycle_fn=class_lookup_cycle_recover, cycle_initial=class_lookup_cycle_initial, heap_size)]
    ...
    #[salsa::tracked(cycle_fn=member_lookup_cycle_recover, cycle_initial=member_lookup_cycle_initial, heap_size)]
